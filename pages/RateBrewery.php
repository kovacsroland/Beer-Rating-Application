        ...
        <div class="container-fluid">
            <div class="col-12 no-space">
                <div class="container custom-form2 mt-5 mb-5">
                    <form action="../php/BreweryRating.php" method="post" id="form1" runat="server" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12 text-center">
                                <h3><?php echo $brewery->getBrewery()['brewery_name'] . " Értékelése"; ?></h3>
                            </div>
